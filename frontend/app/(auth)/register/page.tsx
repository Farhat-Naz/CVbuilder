  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">Start building your professional resume today</p>
      </div>

      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div>
          <Label htmlFor="full_name">Full Name</Label>
          <Input id="full_name" placeholder="John Doe" className="mt-1.5" {...register("full_name")} />
        ...
        <div>
          ...
          <Input id="confirmPassword" type="password" placeholder="Repeat password" className="mt-1.5" {...register("confirmPassword")} />
